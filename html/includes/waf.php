    ...
    if ( is_array($var) ) {
        while (list($key,$value) = each($var)) {
            ...
            switch ($key) {
                ...
                case "piabef_berufsbildung"  : if ($value!=""){if (idnotindb("f_berufsbildung",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "piabef_einkuenfte"     : if ($value!=""){if (idnotindb("f_einkuenfte",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "piabef_familienstand"  : if ($value!=""){if (idnotindb("f_familienstand",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "piabef_weiterbehandlung1"   : if ($value!=""){if (idnotindb("f_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung2"   : if ($value!=""){if (idnotindb("f_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung3"   : if ($value!=""){if (idnotindb("f_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung_evb": if ($value!=""){if (idnotindb("f_kliniken_evb",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_wohnort"        : if ($value!=""){if (idnotindb("f_wohnort",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_wohnsituation"  : if ($value!=""){if (idnotindb("f_wohnsituation",$value)){$error=true;}} else {$error=true;} break;
