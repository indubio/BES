<?php
function idnotindb($table, $value) {
    $checkok = true;
    if ($value != -1) {
...
function isnotfalldbid($value, $db = "stat") {
    switch ($db) {
    ...
    if (ctype_digit($value)) {
        ...
        $result = mysql_query($query);
        if (mysql_num_rows($result) != 1){$checknok = true;} else {$checknok = false;}
        mysql_free_result($result);
    } else {$checkok = false;}
    return $checknok;
}

function isnotintable($value, $db) {
    $checkok = true;
    if (ctype_digit($value)) {
    ...
    if ( is_array($var) ) {
        while (list($key,$value) = each($var)) {
            ...
            switch ($key) {
                ...
                case "ajax_tt_id"            : if ($value!=""){if (isnotintable($value,"tooltips")){$error=true;}} else {$error=true;} break;
                case "amodus"                : if ($value!=""){if (idnotindb("f_amodus",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "begleitung1"           : if ($value!=""){if (idnotindb("f_begleitung",$value)){$error=true;}} else {$error=true;} break;
                case "begleitung2"           : if ($value!=""){if (idnotindb("f_begleitung",$value)){$error=true;}} else {$error=true;} break;
                case "behandler"             : if ($value!=""){if (idnotindb("user",$value)){$error=true;}} else {$error=true;} break;
                case "berufsbildung"         : if ($value!=""){if (idnotindb("f_berufsbildung",$value)){$error=true;}} else {$error=true;} break;
                case "betreuung"             : if ($value!=""){if (idnotindb("f_betreuung",$value)){$error=true;}} else {$error=true;} break;
                case "cur_msg"               : break;
                ...
                case "fall_dbid"             : if ($value!=""){if (isnotfalldbid($value)){$error=true;}}break;
                case "fall_dbid_pia"         : if ($value!=""){if (isnotfalldbid($value,"pia")){$error=true;}}break;
                case "fall_dbids"            : break;
                case "fall_dbtbl"            : break;
                case "familienname"          : break;
                case "familienstand"         : if ($value!=""){if (idnotindb("f_familienstand",$value)){$error=true;}} else {$error=true;} break;
                case "geburtsdatum"          : if ($value!=""){if (isnotdate($value)){$error=true;}} break;
                case "geschlecht"            : if ($value!=""){if (idnotindb("f_geschlecht",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "migration"             : if ($value!=""){if (idnotindb("f_migration",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "somdiag1"              : if ($value!=""){if (isnotadiag($value)){$error=true;}} break;
                case "somdiag2"              : if ($value!=""){if (isnotadiag($value)){$error=true;}} break;
                case "station_a"             : if ($value!=""){if (idnotindb("f_psy_stationen",$value)){$error=true;}} else {$error=true;} break;
                case "station_c"             : if ($value!=""){if (idnotindb("f_psy_stationen",$value)){$error=true;}} else {$error=true;} break;
                case "station_e"             : if ($value!=""){if (idnotindb("f_psy_stationen",$value)){$error=true;}} else {$error=true;} break;
                case "stationid"             : if ($value!="-1"){if (idnotindb("f_psy_stationen",$value)){$error=true;}} else {$error=false;} break;
                ...
                case "vorname"               : break;
                case "weiterbehandlung1"     : if ($value!=""){if (idnotindb("f_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "weiterbehandlung2"     : if ($value!=""){if (idnotindb("f_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "weiterbehandlung3"     : if ($value!=""){if (idnotindb("f_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "weiterbehandlung_evb"  : if ($value!=""){if (idnotindb("f_kliniken_evb",$value)){$error=true;}} else {$error=true;} break;
                case "which_date"            : break;
                case "wohnort_a"             : if ($value!=""){if (idnotindb("f_wohnort",$value)){$error=true;}} else {$error=true;} break;
                case "wohnort_e"             : if ($value!=""){if (idnotindb("f_wohnort",$value)){$error=true;}} else {$error=true;} break;
                case "wohnsituation_a"       : if ($value!=""){if (idnotindb("f_wohnsituation",$value)){$error=true;}} else {$error=true;} break;
                case "wohnsituation_e"       : if ($value!=""){if (idnotindb("f_wohnsituation",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_behandler"      : if ($value!=""){if (idnotindb("user",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_berufsbildung"  : if ($value!=""){if (idnotindb("f_pia_berufsbildung",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "piabef_einkuenfte"     : if ($value!=""){if (idnotindb("f_pia_einkuenfte",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_entlassdatum"   : if ($value!=""){if (isnotdate($value)){$error=true;}} break;
                case "piabef_entlassmodus"   : if ($value!=""){if (idnotindb("f_emodus",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_fall_dbid"      : if ($value!=""){if (isnotfalldbid($value,"pia")){$error=true;}}break;
                case "piabef_familienstand"  : if ($value!=""){if (idnotindb("f_pia_familienstand",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "piabef_migration"      : if ($value!=""){if (idnotindb("f_pia_migration",$value)){$error=true;}} else {$error=true;} break;
                ...
                case "piabef_psydiag1"       : if ($value!=""){if (isnotadiag($value)){$error=true;}} break;
                case "piabef_psydiag2"       : if ($value!=""){if (isnotadiag($value)){$error=true;}} break;
                case "piabef_somdiag1"       : if ($value!=""){if (isnotadiag($value)){$error=true;}} break;
                case "piabef_somdiag2"       : if ($value!=""){if (isnotadiag($value)){$error=true;}} break;
                case "piabef_symptomatik"    : if ($value!=""){if (idnotindb("f_pia_symptomatik",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung1"   : if ($value!=""){if (idnotindb("f_pia_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung2"   : if ($value!=""){if (idnotindb("f_pia_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung3"   : if ($value!=""){if (idnotindb("f_pia_weiterbehandlung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_weiterbehandlung_evb": if ($value!=""){if (idnotindb("f_kliniken_evb",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_wohnort"        : if ($value!=""){if (idnotindb("f_pia_wohnort",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_wohnsituation"  : if ($value!=""){if (idnotindb("f_pia_wohnsituation",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_wohngemeinschaft": if ($value!=""){if (idnotindb("f_pia_wohngemeinschaft",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_zusatzbetreuung1" : if ($value!=""){if (idnotindb("f_pia_zusatzbetreuung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_zusatzbetreuung2" : if ($value!=""){if (idnotindb("f_pia_zusatzbetreuung",$value)){$error=true;}} else {$error=true;} break;
                case "piabef_zuweisung"        : if ($value!=""){if (idnotindb("f_pia_zuweisung",$value)){$error=true;}} else {$error=true;} break;
