...
\filbreak
\subsection{Erstkontakt in unserer Klinik}
\colorbox{lightgray}{
  \begin{minipage}{.90\textwidth}
    \begin{description}
      \item[Variable] PNABef\_v09 - <<Erstkontakt>>
      \item[Typ] kategorial
...
out_df <- as.data.frame(table(PNAdata_dc$PNABef_v09, exclude = NULL))
...
out_df$Kategorien <- ordered(out_df$Kategorien, levels=c("ja","nein","keine Angabe"))
